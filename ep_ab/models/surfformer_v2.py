...
from .surfformer_v1 import square_distance, farthest_point_sample, index_points, Encoder
...
class SurfaceTransformerV2(nn.Module):
    ...
    def __init__(self, cfg, ):
        super().__init__()
        self.cfg = cfg
        self.fixed_patches = cfg.patch_setup.fixed_patches
    ...
    def forward(self, batch):
        ...
        loss_dict, out_dict = {'ep': loss_ep_receptor}, {'ep_pred': None, 'ep_pred_coarse': pred_coarse, 'ep_true_coarse': label_coarse,
                                                         'batch_idx': P_receptor['batch'][patch_idx_receptor]}
        return loss_dict, out_dict
