...
class dMaSIFConv(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, radius=1.0, hidden_units=None, cheap=False):
        ...
        # For performance reasons, we cut our "hidden" vectors in n_heads "independent heads" of dimension 8.
    ...
    def forward(self, points, normals, features, ranges=None):
        ...
        Args:
            ...
            normals (Tensor): (N,3) local coordinate systems `n_i`.
