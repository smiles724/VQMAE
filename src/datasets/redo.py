...
from src.utils.geometry import atoms_to_points
from src.utils.protein.constants import AA, num2name, BBHeavyAtom
from src.utils.protein.points import ProteinData
from src.utils.computeHydro import computeHydrophobicity
from src.utils.computeCharges import computeSatisfied_CO_HN, computeChargeHelper
        ...
        for chain in structure.get_chains():
            try:
                    ...
                    if AA.is_aa(resname) and (res.has_id('CA') and res.has_id('C') and res.has_id('N')):  # skip unknown residues
                        ...
                        for atom in res.get_atoms():
                            if atom.name in BBHeavyAtom._member_names_:
                                ...
                                atom_types.append(BBHeavyAtom[atom.element])
                            if atom.name == 'CA':
                ...
                for ix in range(len(pts)):
                    ...
                    res_id = res.get_id()
                    atom_name = num2name[atom_types[knn_atom_idx[ix]]]
